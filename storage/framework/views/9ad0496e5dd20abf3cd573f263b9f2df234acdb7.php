...
<head>
    ...
    <title><?php echo e(config('app.name', 'Pantry')); ?></title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <a href="#" onclick="event.preventDefault();
                                    var x = document.getElementById('column-left');
            ...
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <!-- <?php echo e(config('app.name', 'Pantry')); ?> -->
                    <?php echo e(title_case(Auth::user()->type)); ?> Area
                </a>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a id="logout" class="dropdown-item" href="<?php echo e(route('logout')); ?>"
